            ...
            if(props.dataExcel.data.length>0){
                ...
                toExcel(
                    ...
                    [
                        ...
                        [
                            `SALDO AWAL : ${parseInt(props.dataExcel.summary.saldo_awal,10)}`,
                        ],
                    ]
                )
            }
    ...
    render(){
        ...
        return (
            <WrapperModal isOpen={this.props.isOpen && this.props.type === "detailInvesment"} size="lg">
                <ModalHeader toggle={this.toggle}>Detail Invesment {this.props.detail.fullname} <br/> Saldo Awal : <span className="txtGreen">Rp {summary!==undefined ?toCurrency(parseInt(summary.saldo_awal,10)):0} .-</span></ModalHeader>
                {this.props.isLoading||this.props.isLoadingExcel ?<Preloader/>:null}
                <ModalBody>
                   <div className="row">
                    ...
                    <div style={{overflowX: "auto"}}>
                        <table className="table table-bordered">
                            ...
                            <tr>
                                <th style={headStyle} rowSpan={"2"}>#</th>
                                <th style={headStyle} rowSpan={"2"}>KODE TRANSAKSI</th>
                                <th style={headStyle} rowSpan={"2"}>NAMA</th>
                                <th style={headStyle} colSpan="2">TRANSAKSI</th>
                                <th style={headStyle} rowSpan={"2"}>CATATAN</th>
                                <th style={headStyle} rowSpan={"2"}>TANGGAL</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style={numberStyle} className="txtGreen">Rp {totTrxIn===0?0:toCurrency(totTrxIn)} .-</td>
                                <td style={numberStyle} className="txtGreen">Rp {totTrxOut===0?0:toCurrency(totTrxOut)} .-</td>
                                <td colSpan={2}/>
                            </tr>
                            <tr>
                                <td colSpan={3}>TOTAL KESELURUHAN</td>
                                <td style={numberStyle} className="txtGreen">Rp {summary!==undefined?toCurrency(parseInt(summary.trx_in,10)):0} .-</td>
                                <td style={numberStyle} className="txtGreen">Rp {summary!==undefined?toCurrency(parseInt(summary.trx_out)):0} .-</td>
                                <td colSpan={2}/>
                            </tr>
                            </tfoot>
                        </table>
